		...
		FormValidation.I18n = $.extend(true, FormValidation.I18n, {
			'ja_JP': {
				base64: {
					...
					'default': '%sから%sの間で入力してください', notInclusive: '厳密に%sから%sの間で入力してください'
				}, bic: {
					...
					'default': '%sより大きい値を入力してください', notInclusive: '%sより大きい値を入力してください'
				}, grid: {
					'default': '有効なGRIdコードを入力してください'
				}, hex: {
					'default': '有効な16進数を入力してください。'
				}, iban: {
					'default': '有効なIBANコードを入力してください', country: '有効な%sのIBANコードを入力してください', countries: {
						AD: 'アンドラ',
						AE: 'アラブ首長国連邦',
						AL: 'アルバニア',
						AO: 'アンゴラ',
					...
					'default': '有効なIDを入力してください', country: '有効な%sのIDを入力してください', countries: {
						BA: 'スニア·ヘルツェゴビナ',
						BG: 'ブルガリア',
						BR: 'ブラジル',
						CH: 'スイス',
					...
					'default': '有効なIPアドレスを入力してください', ipv4: '有効なIPv4アドレスを入力してください', ipv6: '有効なIPv6アドレスを入力してください'
				}, isbn: {
					...
					'default': '%s未満の値を入力してください', notInclusive: '%s未満の値を入力してください'
				}, mac: {
					...
					'default': '有効な電話番号を入力してください', country: '有効な%sの電話番号を入力してください', countries: {
						AE: 'アラブ首長国連邦',
						BG: 'ブルガリア',
						BR: 'ブラジル',
						CN: 'チャイナ',
					...
					'default': '小文字のみで入力してください', upper: '大文字のみで入力してください'
				}, stringLength: {
					...
					'default': '有効なUUIDを入力してください', version: '有効なバージョン%s UUIDを入力してください'
				}, vat: {
					'default': '有効なVAT番号を入力してください', country: '有効な%sのVAT番号を入力してください', countries: {
						AT: 'オーストリア',
						BE: 'ベルギー',
						BG: 'ブルガリア',
						BR: 'ブラジル',
					...
					'default': '有効な郵便番号を入力してください', country: '有効な%sの郵便番号を入力してください', countries: {
						AT: 'オーストリア',
						BG: 'ブルガリア',
						BR: 'ブラジル',
						CA: 'カナダ',
