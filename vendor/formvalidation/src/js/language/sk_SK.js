		...
		FormValidation.I18n = $.extend(true, FormValidation.I18n, {
			'sk_SK': {
				base64: {
					...
					'default': 'Prosím zadajte správne UUID číslo', version: 'Prosím zadajte správne UUID vo verzii %s'
				}, vat: {
					...
					'default': 'Prosím zadajte správne PSČ', country: 'Prosím zadajte správne PSČ pre %s', countries: {
						AT: 'Rakúsko',
						BG: 'Bulharsko',
						BR: 'Brazíliu',
						CA: 'Kanadu',
