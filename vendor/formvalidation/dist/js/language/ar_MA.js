		...
		FormValidation.I18n = $.extend(true, FormValidation.I18n, {
			'ar_MA': {
				base64: {
					...
					'default': 'الرجاء إدخال قيمة بين %s و %s .', notInclusive: 'الرجاء إدخال قيمة بين %s و %s بدقة.'
				}, bic: {
					...
					'default': 'الرجاء إدخال قيمة أكبر من أو تساوي %s.', notInclusive: 'الرجاء إدخال قيمة أكبر من %s.'
				}, grid: {
					'default': 'الرجاء إدخال رقم GRid صالح.'
				}, hex: {
					'default': 'الرجاء إدخال رقم ست عشري صالح.'
				}, iban: {
					'default': 'الرجاء إدخال رقم IBAN صالح.', country: 'الرجاء إدخال رقم IBAN صالح في %s.', countries: {
						AD: 'أندورا',
					...
					'default': 'الرجاء إدخال قيمة أصغر من أو تساوي %s.', notInclusive: 'الرجاء إدخال قيمة أصغر من %s.'
				}, mac: {
					...
					'default': 'الرجاء إدخال رقم هاتف صحيح.', country: 'الرجاء إدخال رقم هاتف صالح في %s.', countries: {
						AE: 'الإمارات العربية المتحدة',
						BG: 'بلغاريا',
						BR: 'البرازيل',
						CN: 'الصين',
					...
					'default': 'الرجاء إدخال أحرف صغيرة فقط.', upper: 'الرجاء إدخال أحرف كبيرة فقط.'
				}, stringLength: {
					...
					'default': 'الرجاء إدخال رقم UUID صالح.', version: 'الرجاء إدخال رقم UUID صالح إصدار %s.'
				}, vat: {
					'default': 'الرجاء إدخال رقم VAT صالح.', country: 'الرجاء إدخال رقم VAT صالح في %s.', countries: {
						AT: 'النمسا',
						BE: 'بلجيكا',
						BG: 'بلغاريا',
						BR: 'البرازيل',
