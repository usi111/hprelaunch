		...
		FormValidation.I18n = $.extend(true, FormValidation.I18n, {
			'he_IL': {
				base64: {
					...
					'default': 'נא להזין ערך בין %s ל-%s', notInclusive: 'נא להזין ערך בין %s ל-%s בדיוק'
				}, bic: {
					...
					'default': 'נא להזין ערך גדול או שווה ל-%s', notInclusive: 'נא להזין ערך גדול מ-%s'
				}, grid: {
					'default': 'נא להזין מספר GRId תקין'
				}, hex: {
					'default': 'נא להזין מספר הקסדצימלי תקין'
				}, iban: {
					'default': 'נא להזין מספר IBAN תקין', country: 'נא להזין מספר IBAN תקני ב%s', countries: {
						AD: 'אנדורה',
					...
					'default': 'נא להזין מספר זהות תקין', country: 'נא להזין מספר זהות תקני ב%s', countries: {
						BA: 'בוסניה והרצגובינה',
						BG: 'בולגריה',
						BR: 'ברזיל',
						CH: 'שווייץ',
					...
					'default': 'נא להזין ערך קטן או שווה ל-%s', notInclusive: 'נא להזין ערך קטן מ-%s'
				}, mac: {
					...
					'default': 'נא להין מספר טלפון תקין', country: 'נא להזין מספר טלפון תקין ב%s', countries: {
						AE: 'איחוד האמירויות הערבי',
						BG: 'בולגריה',
						BR: 'ברזיל',
						CN: 'סין',
					...
					'default': 'נא להזין אותיות קטנות בלבד', upper: 'נא להזין אותיות גדולות בלבד'
				}, stringLength: {
					...
					'default': 'נא להזין מספר UUID תקין', version: 'נא להזין מספר UUID גרסה %s תקין'
				}, vat: {
					'default': 'נא להזין מספר VAT תקין', country: 'נא להזין מספר VAT תקין ב%s', countries: {
						AT: 'אוסטריה',
						BE: 'בלגיה',
						BG: 'בולגריה',
						BR: 'ברזיל',
					...
					'default': 'נא להזין מיקוד תקין', country: 'נא להזין מיקוד תקין ב%s', countries: {
						AT: 'אוסטריה',
						BG: 'בולגריה',
						BR: 'ברזיל',
						CA: 'קנדה',
