		...
		FormValidation.I18n = $.extend(true, FormValidation.I18n, {
			'vi_VN': {
				base64: {
					...
					'default': 'Vui lòng nhập mã ID hợp lệ', country: 'Vui lòng nhập mã ID hợp lệ của %s', countries: {
						BA: 'Bosnia và Herzegovina',
						BG: 'Bulgaria',
						BR: 'Brazil',
						CH: 'Thuỵ Sĩ',
					...
					'default': 'Vui lòng nhập ký tự thường', upper: 'Vui lòng nhập ký tự in hoa'
				}, stringLength: {
					...
					'default': 'Vui lòng nhập số UUID hợp lệ', version: 'Vui lòng nhập số UUID phiên bản %s hợp lệ'
				}, vat: {
